...
class MatchResultResponse(BaseModel):
    ...
    matched_skills: Optional[List[str]] = Field(None, validation_alias="strengths")
    missing_skills: Optional[List[str]] = Field(None, validation_alias="weaknesses")
    explanation: Optional[str] = Field(None, validation_alias="gemini_summary")
